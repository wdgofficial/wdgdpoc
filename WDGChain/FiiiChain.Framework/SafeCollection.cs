...
namespace FiiiChain.Framework
{
    ...
    public class SafeCollection<T> : IList<T>
    {
        #region Variables
        ...
        /// <returns></returns>
        public static implicit operator SafeCollection<T>(List<T> value)
        {
            return new SafeCollection<T>(value);
        }
        ...
        /// <summary>
        /// Finalizes an instance of the <see cref="TList{T}"/> class. 
        /// </summary>
        ~SafeCollection()
        {
