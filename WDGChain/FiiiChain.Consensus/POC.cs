...
namespace FiiiChain.Consensus
{
    public class POC
    {
        ...
        const long INIT_COINS = (long)5.256E+16;        //5亿
        const long GENESIS_BLOCK_COINS = (long)5.0E+17; //50亿
        const long BLOCK_REWARD_HALVE_STEP = 525600L;
        
        const string SUPER_NODE_PUBLIC_KEY_TEST = "";
        const string SUPER_NODE_PUBLIC_KEY_MAIN = "302A300506032B65700321005AE04ED4D3CF654C1DE2B9CC5DD56B294D0BDADC0A3296360DC89856FC170BDD";
        ...
        const long defaultBits = 0x20009896; //0.00000001:0x2005F5E0; 0.0000001:0x20009896; 0.000001:0x1F0F423F; //0.00001:1F01869F; 0.0001:1E270FFF; 0.001:0x1E03E7FF; 0.01:0x1D63FFFF; 0.1:0x1D09FFFF; 1:0x1d00FFFF
        ...
        public const long DIFFIUCLTY_ADJUST_STEP = 2880;//难度调节的区块数
        ...
        public static long GetNewBlockReward(long height)
        {
            ...
            else
            {
                ...
                if (times < 50)
                    return INIT_COINS * (int)(Math.Pow(0.9, times)) / BLOCK_REWARD_HALVE_STEP;
                else
                    return 0;
            }
        }
        ...
        public static long CalculateBaseTarget(long currentHeight, long preBits,long preTimestamp, Block prevStepBlockMsg)
        {
            if (currentHeight <= 1)
            {
            ...
            {
                var bits = prevStepBlockMsg.Bits;
                ...
                var actualTimespan = preTimestamp - prevStepBlockMsg.Timestamp;
        ...
        public static long CalculateBaseTarget(long currentHeight, Block prevBlockMsg, Block prevStepBlockMsg)
        {
            long preBits, preTimestamp;
            if (prevBlockMsg != null)
            {
                preBits = prevBlockMsg.Bits;
                preTimestamp = prevBlockMsg.Timestamp;
            }
            else
            {
                preBits = 0;
            ...
            return CalculateBaseTarget(currentHeight, preBits, preTimestamp, prevStepBlockMsg);
        }
